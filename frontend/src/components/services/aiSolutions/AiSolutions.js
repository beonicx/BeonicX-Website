// AI Solutions & Machine Learning Services Page
'use client'
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium">Enterprise AI Integration Experts</span>
              </motion.div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Seamless <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-400 to-blue-300">AI Agents</span> Integration
              </h1>
              <p className="text-xl mb-8 text-slate-100 leading-relaxed">
                Deploy autonomous AI agents into your existing workflows — from customer support and sales automation to data intelligence and multi-agent orchestration. Built on LLMs, RAG, and production-grade infrastructure.
              </p>
                ...
                <div className="relative perspective-container">
                  ...
                  >
                    <Image
                      ...
                      alt="AI and machine learning development workspace with neural network visualizations"
                      width={500}
                      height={400}
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-800">AI-Native Stack</span>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-800">Enterprise-Grade AI</span>
                    </div>
                  </motion.div>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className={`text-lg ${darkMode ? 'text-slate-300' : 'text-slate-600'} max-w-3xl mx-auto leading-relaxed`}>
              From custom model training to production deployment, we deliver end-to-end AI solutions that automate decisions, uncover insights, and scale your competitive advantage.
            </p>
          </motion.div>
      ...
      <section className={`py-24 px-4 ${darkMode ? 'bg-slate-950' : 'bg-white'} relative`}>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className={`text-lg ${darkMode ? 'text-slate-300' : 'text-slate-600'} max-w-3xl mx-auto leading-relaxed`}>
              We leverage cutting-edge AI frameworks and cloud infrastructure to build intelligent, scalable, and production-ready AI systems.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                gradient: "from-blue-600 to-blue-400",
                techs: ["PyTorch", "TensorFlow", "LangChain", "Hugging Face", "OpenAI"]
              },
              {
                category: "Data & Vector DBs",
                gradient: "from-blue-600 to-blue-700",
                techs: ["Pinecone", "Weaviate", "PostgreSQL", "MongoDB", "Redis"]
              },
              {
                category: "Cloud & MLOps",
                gradient: "from-blue-600 to-blue-700",
                techs: ["AWS SageMaker", "Google Vertex", "Azure ML", "Docker", "Kubernetes"]
              },
              {
                category: "Languages & Tools",
                gradient: "from-blue-400 to-blue-600",
                techs: ["Python", "TypeScript", "FastAPI", "Ray", "MLflow"]
              }
