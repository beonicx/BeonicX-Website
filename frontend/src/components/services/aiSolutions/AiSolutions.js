          ...
          >
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Advanced <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-pink-300 to-cyan-300">AI Solutions</span> &amp; Machine Learning
              </h1>
              <p className="text-xl mb-8 text-gray-100 leading-relaxed">
                Harness the power of artificial intelligence to automate workflows, gain insights, and drive innovation. We build custom AI models and intelligent systems tailored to your business.
              </p>
