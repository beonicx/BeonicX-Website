          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium">Certified Cloud Architects</span>
              </motion.div>
                ...
                <div className="relative perspective-container">
                  ...
                  >
                    <Image
                      ...
                      alt="Cloud infrastructure and DevOps dashboard with monitoring metrics"
                      width={500}
                      height={400}
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-800">Multi-Cloud Certified</span>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-800">99.99% Uptime</span>
                    </div>
                  </motion.div>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${darkMode ? 'text-white' : 'text-slate-900'}`}>
              Full-Spectrum Cloud & Infrastructure Services
            </h2>
            <p className={`text-lg ${darkMode ? 'text-slate-300' : 'text-slate-600'} max-w-3xl mx-auto leading-relaxed`}>
              From cloud migration to Kubernetes orchestration, we deliver secure, scalable infrastructure solutions that reduce costs and accelerate deployment.
            </p>
          </motion.div>
      ...
      <section className={`py-24 px-4 ${darkMode ? 'bg-slate-950' : 'bg-white'} relative`}>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className={`text-lg ${darkMode ? 'text-slate-300' : 'text-slate-600'} max-w-3xl mx-auto leading-relaxed`}>
              We leverage industry-leading cloud platforms and DevOps tools to build resilient, secure, and cost-efficient infrastructure.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                gradient: "from-blue-600 to-blue-700",
                techs: ["AWS", "Google Cloud", "Azure", "DigitalOcean", "Cloudflare"]
              },
              {
                category: "Containers & Orchestration",
                gradient: "from-blue-600 to-blue-700",
                techs: ["Docker", "Kubernetes", "Helm", "Istio", "ArgoCD"]
              },
              {
                category: "IaC & CI/CD",
                gradient: "from-blue-600 to-blue-400",
                techs: ["Terraform", "Pulumi", "GitHub Actions", "GitLab CI", "Jenkins"]
              },
              {
                category: "Monitoring & Security",
                gradient: "from-blue-400 to-blue-600",
                techs: ["Prometheus", "Grafana", "Datadog", "Vault", "Sentry"]
              }
