...
const ServicesSlider = ({
  ...
  return (
    <div className="w-full relative py-12 px-4 sm:px-6 lg:px-12 transition-all duration-500">
      ...
      <p className={`text-center max-w-3xl mx-auto text-base mb-10 ${darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
        {description}
      </p>
      ...
      <button
        onClick={prevSlide}
        className="absolute top-1/2 left-2 transform -translate-y-1/2 z-10 bg-slate-100 dark:bg-slate-800 p-2 rounded-full shadow hover:bg-slate-200 dark:hover:bg-slate-700"
      >
        <svg className="w-6 h-6 text-slate-800 dark:text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <button
        onClick={nextSlide}
        className="absolute top-1/2 right-2 transform -translate-y-1/2 z-10 bg-slate-100 dark:bg-slate-800 p-2 rounded-full shadow hover:bg-slate-200 dark:hover:bg-slate-700"
      >
        <svg className="w-6 h-6 text-slate-800 dark:text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
